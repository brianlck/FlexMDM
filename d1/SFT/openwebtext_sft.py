...
def parse_args():
    ...
    parser.add_argument("--beta", type=float, default=0.5, help="beta for the variable length training")
...
def train_model(args, tokenizer, model):
    ...
    if args.variable_length:
        ...
        trainer = dLLMVariableLengthTrainer(
            ...
            max_length=args.sft_max_length, beta = args.beta, compute_metrics = None, 
